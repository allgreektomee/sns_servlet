...
public class ListenerExam implements ServletContextListener, ServletContextAttributeListener, HttpSessionListener, HttpSessionAttributeListener {
    ...
    public void contextInitialized(ServletContextEvent sce)  { 
    	sce.getServletContext().log("ServletContext start - contextInitialized ");
    }

    // ServletContext 종료
    public void contextDestroyed(ServletContextEvent sce)  { 
    	sce.getServletContext().log("ServletContext end - contextDestroyed");
    }
//
//    // ServletContext에 속성 추가
//    public void attributeAdded(ServletContextAttributeEvent scae)  { 
//    	scae.getServletContext().log("ServletContext attributeAdded: "+scae.getValue());
//    }
//
